...
public class NodeRPCConnection implements AutoCloseable {
    ...
    public void initialiseNodeRPCConnection() {
        ...
        CordaRPCClientConfiguration configuration = new CordaRPCClientConfiguration(Duration.ofMinutes(3), 7, java.lang.Boolean.getBoolean("net.corda.client.rpc.trackRpcCallSites"), Duration.ofSeconds(1), 4, 1, Duration.ofSeconds(5), new Double(1), 10, 10485760, Duration.ofDays(1));
